...
import {ScrollView, Text, StyleSheet, TextInput, TouchableOpacity, ImageBackground, Alert} from "react-native"
...
const UserRegisterPage = ({navigation}) =>{
    ...
    function register(){
        ...
        if(email === "" || name === "" ||  mobileNo === "" || address === "" || birthYear === "" || gender === "" || weight === "" || height === "" || city === "" || password === "" || rePassword === ""){
        ...
        if (password.length <= 5){
            Alert.alert("Invalid Input", "Password should be more than 5 characters !");
            return;
        }
    ...
    return( 
        ...
        <ScrollView >
            ...
            <TextInput style={styles.input} placeholder="example@gmail.com" name="email" value={email} onChangeText={text => setEmail(text)}></TextInput>

            <Text style={styles.text}>Name</Text>
            <TextInput style={styles.input} name="name" value={name} onChangeText={text => setName(text)}></TextInput>

            <Text style={styles.text}>Mobile No</Text>
            <TextInput style={styles.input} placeholder="07XXXXXXXX" name="mobile" value={mobileNo} onChangeText={text => setMobileNo(text)}></TextInput>

            <Text style={styles.text}>Birth Year</Text>
            <TextInput style={styles.input} name="age" value={birthYear} onChangeText={text => setBirthYear(text)}></TextInput>
            ...
            <TextInput style={styles.input} placeholder="Enter Weight in kg" name="weight" value={weight} onChangeText={text => setWeight(text)}></TextInput>

            <Text style={styles.text}>Height</Text>
            <TextInput style={styles.input} placeholder="Enter Height in cm" name="height" value={height} onChangeText={text => setHeight(text)}></TextInput>
            ...
            <TextInput style={styles.input} placeholder="Enter Password" name="password" secureTextEntry={true} value={password} onChangeText={text => setPassword(text)}></TextInput>

            <Text style={styles.text}>Re-Enter Password</Text>
            <TextInput style={styles.input} placeholder="Re-Enter Password" name="re-password" secureTextEntry={true} value={rePassword} onChangeText={text => setRePassword(text)}></TextInput>
